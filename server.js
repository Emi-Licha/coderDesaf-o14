...
var puerto = 8080;
var rutaM = "./mensajes.txt";
var productos_js_1 = require("./api/productos.js");
...
var routes_js_1 = require("./router/routes.js");
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, fs_1["default"].promises.readFile(rutaM)];
                case 1:
                    archivo = _a.sent();
                    messages = JSON.parse(archivo.toString());
                    return [3 /*break*/, 3];
                case 2:
                    err_1 = _a.sent();
...
io.on("connection", function (socket) {
    ...
    socket.on("new-message", function (data) {
        ...
        var dato = JSON.stringify(messages, null, 2);
        fs_1["default"].writeFileSync(rutaM, dato, 'utf-8');
    });
});
